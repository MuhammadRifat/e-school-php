<!-- footer section -->
<footer class="text-white bgc-primary mt-5">
    <section class="container">
        <div class="row py-3">
            <div class="col-md-3">
                <h4 class="mb-4">E-School</h4>
                <a href="#"> <i class="fab fa-facebook-square" style="font-size: 24pt;"></i></a>
                <a href="#"> <i class="fab fa-linkedin" style="font-size: 24pt; margin-left: 10px;"></i></a>
                <a href="#"> <i class="fab fa-instagram-square" style="font-size: 24pt; margin-left: 10px;"></i></a>
                <a href="#"> <i class="fab fa-youtube-square" style="font-size: 24pt; margin-left: 10px;"></i></a>
                <p class="my-3">For Problem: 01625-888437</small><br/>
            </div>
            <div class="col-md-3">
                <h4>Address</h4>
                <p>contact: 01625-888437</small><br/>
                <p>email: <a href="mailto:riyadhossaint100@gmail.com" target="_blank"> riyadhossaint100@gmail.com</a></small><br/>
